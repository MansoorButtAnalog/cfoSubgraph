...
import { cfoPayContract, Stream, Token, User } from "../../generated/schema";
...
export function loadStream(contractAddress: Address, streamId: Bytes, contract: cfoPayContract, payer: User, payee: User, token: Token, amountPerSec: BigInt, block: BigInt, timestamp: BigInt): Stream {
    // Unique stream id
