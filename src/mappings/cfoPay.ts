...
import { HistoryEvent, cfoPayContract, Token } from "../../generated/schema";
import { PayerDeposit, PayerWithdraw, StreamCancelled, StreamCreated, StreamCreatedWithReason, StreamModified, StreamPaused, Withdraw } from "../../generated/templates/cfoPay/cfoPay";
...
export function onPayerDeposit(event: PayerDeposit): void {
  ...
  // Load contract
  const contract = cfoPayContract.load(contractAddress.toHexString())!;
